...
# Let's prepend it to PATH right away, as we'll be invoking the toolchain tools
# to check them later
PATH="$OPT_PATH_PREPEND$PATH"
...
CONFIG_PATH_PREPEND=${OPT_PATH_PREPEND}
...
case ${HOST_CC_MACHINE} in
    arm64-*darwin*|aarch64-*darwin*)
        ...
        # For this reason, make it overridable, unlike in the other case
